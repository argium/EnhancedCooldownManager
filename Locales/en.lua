...
L["ADD_ITEM"] = "Item"
L["ADD_SPELL"] = "Spell"
L["ITEM_SETS"] = "Item Sets"
L["ITEM_SET"] = "Set"
L["ITEM_SET_ITEMS"] = "Items"
L["ITEM_SET_NONE"] = "Create an item set to start adding items."
L["ITEM_SET_NO_ITEMS"] = "No items configured for this set."
L["ITEM_SET_MISSING"] = "Missing item set"
L["ITEM_SET_SELECT_PLACEHOLDER"] = "Choose an item set"
L["ITEM_SET_SELECT_DESC"] = "Select the item set to edit."
L["ITEM_SET_CREATE_PROMPT"] = "Name this item set:"
L["ITEM_SET_RENAME_PROMPT"] = "Rename this item set:"
L["ITEM_SET_DELETE_CONFIRM"] = "Delete %s?"
L["ITEM_SET_REMOVE_ITEM_CONFIRM"] = "Remove %s?"
L["ITEM_SET_DUPLICATE_ITEM"] = "Already in this set"
L["CREATE_ITEM_SET"] = "Create item set"
L["CREATE_ITEM_SET_DESC"] = "Create a named item priority list."
L["RENAME_ITEM_SET"] = "Rename item set"
L["RENAME_ITEM_SET_DESC"] = "Rename the selected item set."
L["DELETE_ITEM_SET"] = "Delete item set"
L["DELETE_ITEM_SET_DESC"] = "Delete the selected item set and remove it from viewers."
L["EXTRA_ICONS_ITEM_SET_SELECT_DESC"] = "Choose the item set used by the Set add mode."
