...
L["WHATS_NEW_UNAVAILABLE"] = "No What's New popup is available for this release."
...
L["SHOW_WHATS_NEW_ON_UPDATE"] = "Show What's New on Update"
L["SHOW_WHATS_NEW_ON_UPDATE_DESC"] =
    "Show a one-time What's New popup after updating to a release that explicitly includes one."
L["SHOW_WHATS_NEW"] = "Show What's New"
L["SHOW_WHATS_NEW_DESC"] = "Open the What's New popup for the current version when it is available."
