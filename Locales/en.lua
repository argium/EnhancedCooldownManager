...
L["ADD_ITEM"] = "Item"
L["ADD_SPELL"] = "Spell"
L["ITEM_STACKS"] = "Item Stacks"
L["ITEM_STACK"] = "Stack"
L["ITEM_STACK_ITEMS"] = "Items"
L["ITEM_STACK_NONE"] = "Create an item stack to start adding items."
L["ITEM_STACK_NO_ITEMS"] = "No items configured for this stack."
L["ITEM_STACK_MISSING"] = "Missing item stack"
L["ITEM_STACK_SELECT_PLACEHOLDER"] = "Choose an item stack"
L["ITEM_STACK_SELECT_DESC"] = "Select the item stack to edit."
L["ITEM_STACK_CREATE_PROMPT"] = "Name this item stack:"
...
L["ITEM_STACK_HIDE_IN_RATED_PVP"] = "Hide in: Rated PvP"
L["ITEM_STACK_HIDE_IN_RATED_PVP_DESC"] = "Hide this item stack in rated PvP maps."
L["SHOW_IF_MISSING"] = "Show if missing"
L["SHOW_IF_MISSING_TOOLTIP"] = "Display the icon even none of the items are in your inventory."
L["CREATE_ITEM_STACK"] = "Create item stack"
L["CREATE_ITEM_STACK_DESC"] = "Create a named item priority list."
L["RENAME_ITEM_STACK"] = "Rename item stack"
L["RENAME_ITEM_STACK_DESC"] = "Rename the selected item stack."
L["DELETE_ITEM_STACK"] = "Delete item stack"
L["DELETE_ITEM_STACK_DESC"] = "Delete the selected item stack and remove it from viewers."
L["REVERT"] = "Revert"
L["REVERT_ITEM_STACK"] = "Revert to default"
L["REVERT_ITEM_STACK_DESC"] = "Restore this item stack's default items and visibility settings."
L["EXTRA_ICONS_ITEM_STACK_SELECT_DESC"] = "Choose the item stack used by the Stack add mode."
...
L["CREATE"] = "Create"
L["DONT_CREATE"] = "Don't create"
L["RESET"] = "Reset"
L["DONT_RESET"] = "Don't reset"
L["RESET_PAGE_TO_DEFAULTS_CONFIRM"] = "Reset %s to defaults?"
L["RESET_PROFILE_TO_DEFAULTS_CONFIRM"] = "Reset ALL settings on this profile to default? This cannot be undone."
L["RENAME"] = "Rename"
...
L["WHATS_NEW_BODY"] =
    ...
    .. "### Item Stacks\n\n"
    .. "Stacks allow you to combine multiple items into a single icon in the cooldown manager. The first available item in the stack will be displayed, allowing you to track potions or items that share a cooldown.\n\n"
    .. "Check out the new Item Stacks settings under Extra Icons to create your own stacks.\n\n"
    .. "### External Defensives\n\n"
...
L["WARNINGS"] = "Warnings"
L["WARNINGS_DESC"] = "Log targeted warning diagnostics to chat and DevTool without enabling full debug mode."
...
L["CMD_HELP_MIGRATION_ROLLBACK"] = "/ecm migration rollback <version> - rollback to a settings version (-1 deletes current only)"
