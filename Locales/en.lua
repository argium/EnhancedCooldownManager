...
L["WHATS_NEW_BODY"] =
    ...
    .. "- Fixed a bug that sometimes prevented Hide while Mounted from working with Druid travel forms.\n"
    .. "- Performance improvements for the Rune Bar, and others generally."
L["CLOSE"] = "Close"
