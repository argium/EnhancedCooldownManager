...
| `ns.ErrorLog(module, message, data?)` | Log targeted warnings to chat and DevTool |
| `ns.ErrorLogOnce(module, key, message, data?)` | Log targeted warnings once per module/key |
