...
function BuffBars:OnEnable()
    ...
    self:RegisterEvent("ZONE_CHANGED", function(...) self:OnZoneChanged(...) end)
    self:RegisterEvent("ZONE_CHANGED_INDOORS", function(...) self:OnZoneChanged(...) end)
    self:RegisterEvent("PLAYER_ENTERING_WORLD", function(...) self:OnZoneChanged(...) end)
